...
cljs.core.Vector.prototype.clojure$browser$dom$DOMBuilder$ = !0;
...
clojure.browser.dom.ensure_element = function(a) {
  return cljs.core.truth_(cljs.core.keyword_QMARK_.call(null, a)) ? clojure.browser.dom.get_element.call(null, a) : cljs.core.truth_(cljs.core.string_QMARK_.call(null, a)) ? clojure.browser.dom.html__GT_dom.call(null, a) : cljs.core.truth_("\ufdd0'else") ? a : null
};
clojure.browser.dom.replace_node = function(a, b) {
  ...
  goog.dom.replaceNode.call(null, d, c);
  return d
};
clojure.browser.dom.set_text = function(a, b) {
  return goog.dom.setTextContent.call(null, clojure.browser.dom.ensure_element.call(null, a), b)
};
...
clojure.browser.dom.set_properties = function(a, b) {
  return goog.dom.setProperties.call(null, clojure.browser.dom.ensure_element.call(null, a), b.strobj)
};
...
var cordova_app = {core:{}};
cordova_app.core.clj__GT_js = function clj__GT_js(b) {
...
cordova_app.core.get_value = function(a) {
  return clojure.browser.dom.get_value.call(null, clojure.browser.dom.get_element.call(null, a))
};
cordova_app.core.set_text = function(a, b) {
  return clojure.browser.dom.set_text.call(null, clojure.browser.dom.get_element.call(null, a), b)
};
cordova_app.core.device_props = cljs.core.Vector.fromArray("platform,version,uuid,name,width,height,colorDepth".split(","));
cordova_app.core.show_device_info = function() {
  var a = cljs.core.seq.call(null, cljs.core.map.call(null, function(a) {
    return cljs.core.vec.call(null, cljs.core.Vector.fromArray([cljs.core.str.call(null, a, "Cell"), device[a]]))
  ...
  if(cljs.core.truth_(a)) {
    ...
    for(cljs.core.nth.call(null, b, 1, null);;) {
      ...
      cordova_app.core.set_text.call(null, b, c);
      a = cljs.core.next.call(null, a);
      if(cljs.core.truth_(a)) {
...
cordova_app.core.compass_enabled_QMARK_ = function() {
...
cordova_app.core.compass = function() {
  return navigator.compass
};
cljs.core.add_watch.call(null, cordova_app.core.heading_watch, null, function(a, b, c, d) {
  return cljs.core.truth_(function() {
    var a = cljs.core.not.call(null, null === c);
    return cljs.core.truth_(a) ? null === d : a
  }()) ? (cordova_app.core.compass.call(null).clearWatch(c), cordova_app.core.set_text.call(null, "headingCell", "Off")) : null
});
cordova_app.core.watch_heading = function() {
  var a = function(a) {
    return cordova_app.core.set_text.call(null, "headingCell", a.magneticHeading)
  }, b = function(a) {
    console.log(cljs.core.str.call(null, "Compass error:", a.code));
    return cordova_app.core.set_text.call(null, "headingCell", a.code)
  }, c = cordova_app.core.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["frequency"], {frequency:1E3}));
  cljs.core.swap_BANG_.call(null, cordova_app.core.heading_watch, function() {
    return cordova_app.core.compass.call(null).watchHeading(a, b, c)
  });
...
clojure.browser.event.listen.call(null, clojure.browser.dom.get_element.call(null, "enableCompassCheckbox"), "\ufdd0'change", function() {
  return cljs.core.truth_(cordova_app.core.compass_enabled_QMARK_.call(null)) ? cljs.core.reset_BANG_.call(null, cordova_app.core.heading_watch, null) : cordova_app.core.watch_heading.call(null)
});
